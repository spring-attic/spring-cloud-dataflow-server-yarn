...
:spring-cloud-dataflow-docs: http://docs.spring.io/spring-cloud-dataflow-admin-yarn/docs/{spring-cloud-dataflow-docs-version}/reference
:spring-cloud-dataflow-docs-current: http://docs.spring.io/spring-cloud-dataflow-admin-yarn/docs/current-SNAPSHOT/reference/html/
:github-repo: spring-cloud/spring-cloud-dataflow-admin-yarn
